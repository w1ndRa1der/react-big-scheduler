...
var SchedulerData = function () {
    ...
    _createClass(SchedulerData, [{
        ...
        value: function getDateLabel() {
            ...
            var dateLabel = start.format('dddd, Do MMM YYYY');
        ...
        value: function _createInitHeaderEvents(header) {
            ...
            var endValue = this.showAgenda ? this.viewType === _index.ViewTypes.Week ? start.add(1, 'weeks').format(_index.DATETIME_FORMAT) : this.viewType === _index.ViewTypes.Day ? start.add(1, 'days').format(_index.DATETIME_FORMAT) : this.viewType === _index.ViewTypes.Month ? start.add(1, 'months').format(_index.DATETIME_FORMAT) : this.viewType === _index.ViewTypes.Year ? start.add(1, 'years').format(_index.DATETIME_FORMAT) : start.add(1, 'quarters').format(_index.DATETIME_FORMAT) : this.viewType === _index.ViewTypes.Day ? start.add(15, 'minutes').format(_index.DATETIME_FORMAT) : start.add(1, 'days').format(_index.DATETIME_FORMAT);
            return {
                time: header.time,
        ...
        value: function _getSpan(startTime, endTime, startDate, endDate) {
            ...
            var start = this.viewType === _index.ViewTypes.Day ? (0, _moment2.default)(startTime).startOf('hour').add(Math.floor((0, _moment2.default)(startTime).minute() / 15) * 15, 'minutes') : (0, _moment2.default)(startTime).startOf('day'),
            ...
            while (time >= start && time < end) {
                ...
                time = this.viewType === _index.ViewTypes.Day ? time.add(15, 'minutes') : time.add(1, 'days');
            }
