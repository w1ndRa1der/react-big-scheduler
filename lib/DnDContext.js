    ...
    this.getDropSpec = function () {
        return {
            drop: function drop(props, monitor, component) {
                ...
                if (viewType !== _index.ViewTypes.Day) endTime = (0, _moment2.default)(resourceEvents.headerItems[leftIndex].start).hour(23).minute(59).second(59).format(_index.DATETIME_FORMAT);
